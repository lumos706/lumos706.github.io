...
PREPARATIONS = (
    PreparationSpec(
        ...
        topic="2026 青海甘肃 8月 高原旅行 出发准备 高原反应 药品 医生 医院 急救 氧气",
    ...
    PreparationSpec(
        ...
        topic="2026 青甘大环线 8月 天气 昼夜温差 防晒 衣物 冲锋衣 羽绒服 墨镜 雨具",
    ...
    PreparationSpec(
        ...
        topic="2026 青甘大环线 出发准备 身份证 驾驶证 保险 预约 门票 酒店 订单 清单",
    ...
    PreparationSpec(
        ...
        topic="2026 中国民航 乘机 行李 充电宝 3C 氧气瓶 药品 托运 随身携带 规定",
    ...
    PreparationSpec(
        ...
        topic="2026 青甘大环线 自驾 租车 出发准备 驾驶证 验车 保险 轮胎 加油 离线地图",
    ...
    PreparationSpec(
        ...
        topic="2026 青海甘肃 公共交通 动车 客运 公交 打车 换乘 行李 出发准备",
